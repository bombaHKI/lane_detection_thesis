...
Another major categorization distinguishes between classical geometric methods and modern deep learning-based approaches. Geometric methods rely on explicit mathematical modeling and spatial reasoning. Typical techniques include RANSAC-based plane fitting, spline approximation, Hough transforms, clustering, and multi-view reconstruction~\cite{isprs-archives-XLII-2-W13-1089-2019,RANSAC}. These methods are interpretable and often independent of training data, making them attractive in applications where reproducibility and physical consistency are essential.
